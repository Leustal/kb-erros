...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('O aumento da capacidade de armazenamento', 'Geral', 'Guias do trabalho em geral
Aumente no quotas no JCA
Procure por disk
Verifique se o servidor que ele está alocado possui espaço para tal aumento', '');
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Comando para verificar o servidor:', 'Geral', 'df -h /vz
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Transformar o usuário em root', 'Geral', 'Perguntar qual ambiente o cliente deseja
Importar
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Questionamento de SO', 'Geral', 'SO padrão das instâncias criadasé almalinux
Caso precise de um Ubunto como SO base ou outra SO, o senhor precisará criar uma VPS Ubuntu ou outra desejada.', '');
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente dúvida ssh porta 22', 'Geral', 'O acesso ssh na porta 22 é permitido apenas para rede local.
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente com dúvida no acesso FTP', 'Geral', '(Cliente) Como Eu acesso via ftp pra fazer o upload dos arquivos?
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Dúvidas sobre a conta teste', 'Geral', 'A conta teste possui um limite de uso de até 14 dias.
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Problema de proxy reverso NGINX', 'Geral', 'Perguntar a IA se o problema da log está relacionado ao proxy reverso, geralmente é necessário criar uma .conf com as configurações de apontamento necessárias no diretorio, para o NGINX funcionar.
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Restrição de quem acessa somente a um ip fixo da empresa', 'Geral', 'Cliente pode fazer via Windows Defender Firewall, dentro da própria VM
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Atualização versão antiga de so e firebird', 'Geral', 'Para fazer tais atualizações sem arriscar a quebra do Sistema/Serviço do Firebird, e evitar a perda de dados, será necessário realizar a criação de novos ambientes contendo as versões do Ubuntu e Firebird desejados.
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Problema de disco não altera na plataforma', 'Geral', 'comando a ser utilizado em seu nodo:
vzctl set 177985 --save --diskspace 100G
verificar o que está consumindo o armazenamento
df -ih', '');
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente alega desligar uma instância sozinha.', 'Geral', 'Quando o senhor a desliga através do ssh, a plataforma automaticamente “percebe” que a instancia está desligada e realiza o início do container, já que o ambiente se encontra como ligado.
Orientações
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente fala de configurar um acesso de uma aplicação EXE no banco de dados para não consumir trafego pela saveincloud.', 'Geral', 'R: A comunicação entre o Banco e o Exe, estando na mesma máquina, não são cobrados.
O exe comunica com o banco em localhost?', '');
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente comenta "sobre consumo de trafego em média 20 Giga por dia … para acesso via terminal 40 usuários media, está muito alto"', 'Geral', 'Valor de tráfego está normal para 40 Usuários conectados no TS.
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Problemas de conexão de rede', 'Geral', 'Perguntar se está tendo lentidão no momento
Como está ocorrendo essa lentidão/queda?
Se for problema no banco, realizar a inspeção dentro da instância do banco', '');
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Banco de dados está sofrendo quedas', 'Geral', 'Como os senhores acessam o banco de dados?
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente gostaria de modificar página de erro 502', 'Geral', 'Necessário utilizar um domínio próprio e desativar o acesso via SLB
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Mudando IPs de saída pelo CPanel e CWP - Bloqueio do Ip de saída (E-mail)', 'Geral', 'https://treinamento.suporte.sic.tec.br/docs/hospedagem-de-sites-dns/mudando-ips-de-saida-pelo-cpanel-e-cwp/
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente pede ajuda para liberação de porta no firewall', 'Geral', 'Segue um link que pode lhe ajudar:
https://www.innov4web.pt/knowledgebase/49/Abrir-portas-no-Windows-Server-2012-2016-2019-and-2022.html', '');
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente pergunta sobre limite de nodes', 'Geral', 'Pode ter até 48 nodes por ambiente
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Ativar licença VM Windows', 'Geral', 'CTID =
Ambiente =
User ID (proprietário) =
Windows = versao
usernode =
enviar para equipe infra', '');
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente aumenta a memória da instância, mas ela para de funcionar.', 'Geral', 'Verificar os processos do cliente, possível sobrecarga de memoria
ll | wc -l
...
netstat -t', '');
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente deseja desativar o acesso SSH', 'Geral', 'Todas as ações, até mesmo o deploy que realiza na instância, utiliza conexões SSH com a instancia para execução dos comandos necessários para a conclusão do deploy.
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('DNS reverso:', 'Geral', 'https://treinamento.suporte.sic.tec.br/docs/uteis/criacao-de-dns-reverso/', '');
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Realização de apontamento do MX para o endereço do servidor', 'Geral', 'Caso não possua acesso ao CWP de gerenciamento, precisarei que nos envie um email para suporte@saveincloud.com solicitando novas credenciais.
...
endereço: seuip
TTL: 14400', '');
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente com problema da própria aplicação ou arquivo/administração de ambiente', 'Geral', 'A administração do ambiente é por conta do cliente, não realizamos gestão ou analises dessa natureza.', '');
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Configuração de email tatransportes', 'Geral', 'Sempre que a configuração solicitar um endereço de entrada/saída, deve utilizar o endereço: server8.pureteserver.com
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Não foi possível se conectar ao servidor de entrada (POP)', 'Geral', 'Exemplo de mail.nascimetal.com.br com SSL/TLS
...
Outgoing Server: mail.nascimetal.com.br
SMTP Port: 25', '');
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Snapshot', 'Geral', 'https://treinamento.suporte.sic.tec.br/docs/snapshots-backup/processo-de-restauracao-de-snapshot/
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente comenta que após migração o Load Average diminui/LA diminui', 'Geral', 'o processo de migração desliga e liga a instância, pode-se perceber que após esta ação a instância realmente diminuiu o LA e isto pode estar relacionado ao fato que o desligamento zerou conexões, filas de I/O e processos em execução.', '');
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Instalação do certificado SSL/https', 'Geral', 'Você pode realizar a instalação do Lets Encrypt e configurar o bloco 443 no nginx para receber as requisições e redirecionar para o IP interno conforme faz via HTTP
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente questiona limite de DNS no certificado SSL', 'Geral', 'Esse limite é do próprio Let’s Encrypt, esse limite não pode ser alterado, pois é uma regra da autoridade certificadora.
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente pergunta sobre preço da licensa do Windows que aparece gratuito', 'Geral', 'Apenas a orquestração das VMs da plataforma pelo painel que não tem custo algum, porém a licença é um preço fixo da propria Microsoft, que seria as licenças aplicadas nas VMs durante a criação das mesmas.
É possível criar VPS sem licensa?
Todas as máquinas fazem cobrança de licença atualmente, não é possivel utilizar sem', '');
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente reclama do site ficar inseguro, custom ssl ativo', 'Geral', 'SSL personalizado está ativo, clique para desativar o ssl personalizado.
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Problema de compartilhamento de pasta no nextcloud', 'Geral', 'Adicionou essa pessoa faltante? Para que tivesse permissão de ver a pasta?
Foi realizado a sincronização em outra máquina?
Teria alguma credencial de acesso para verificação do nosso lado.', '');
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Erro ao abrir o outlook', 'Geral', '"Não é possível iniciar o Microsoft Outlook. Não é possível abrir a janela do Outlook. Não é possível abrir o conjunto de pastas. Falha na tentativa de logon no Microsoft Exchange."
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente reclama de cobranças a mais', 'Geral', 'Verifique o saldo
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Exclusão de nó da topologia', 'Geral', 'Remover na topologia, o nó que aparenta ser a raiz da estrutura, não irá afetar de alguma forma os outros nós?
Não', '');
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Problema no firebird no docker', 'Geral', 'Verificar se a tag da imagem está errada
a estrutura é assim
repositorio/imagem:tag
tag geralmente: firebird:v5.0.0', '');
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente comenta sobre armazenamento de disco que foi realizado um resize Windows Server', 'Geral', 'Verificar o tamanho do disco via ssh acessando o nodo do cliente
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Subir o arquivo de banco de dados na plataforma', 'Geral', 'Procurar o container e diretórios utilizados
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente quer excluir um ip sujo da plataforma', 'Geral', 'A maneira recomendada de realizar o mesmo é utilizar a API para trocar esse ip com um novo ambiente, e posteriormente excluir/remover o IP desse segundo ambiente.
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Espaço em disco disponível', 'Geral', 'Ao passar o mouse por cima do icone de disco, ele mostrará o espaço Utilizado e o Alocado
A outra maneira seria executar o comando du -h no webSSH:
du = Disk Usage
caso queira ver o Livre: df -h', '');
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Sem acesso SSH', 'Geral', 'Verificar se mexeu na authorized_keys
ls -la /root/.ssh
Caso mexa:
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente informa que não possui acesso ao ssh (utilizando Node.js)', 'Geral', 'Explorar arquivos/possível ataque
lsof -p [PID]
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente informa que está com problemas de implantação no arquivo war(tomcat) só carrega', 'Geral', 'Verifique as logs na aplicação:
tail -n 30 jem.log
Realize um teste com o jar para verificar a integridade do arquivo, e verifique o erro.', '');
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente deseja atualizar o ubunto 20.04 para 24.04', 'Geral', 'No momento, a plataforma não possui suporte ao Ubuntu 24.04 e 26.04 mesmo, porém você pode utilizar a imagem dessa versão do Ubuntu via Docker Engine CE, fazendo o docker pull da imagem e depois subindo o container.', '');
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente comenta que não possui diretorio de backup_script.sh em seu banco de dados', 'Geral', 'O script acompanhas as instancias baseadas na imagem da jelastic somente, como o senhor realizou a instalação em uma VPS, do zero, a mesma não possui o script inserido nos diretórios.
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente fala que o site está fora do ar', 'Geral', 'O site do senhor está atrás de um proxy?
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente pede uma redefinição de senha para seu e-mail', 'Geral', 'Solicitar via e-mail
Verifique o e-mail dando um ping mail.dominio
Certifique para onde está apontando e acesse', '');
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente fala sobre senha do root da VM', 'Geral', 'VPSs não precisam de senha para o Root.
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente pergunta os motivos de quedas de determinado dia', 'Geral', 'Que tipo de queda foi identificada por vocês?
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente informa que está recebendo alertas no e-mail de sua instância', 'Geral', 'Verifique se o alerta está configurado no ambiente do cliente
Configurações/Alertas de Load/ Verificar RAM/CPU se está acima do normal', '');
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente pergunta sobre a expiração de senha', 'Geral', 'O aviso de expiração de senha é feito a cada 180 dias', '');
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente não consegue adicionar mais instâncias em seu ambiente', 'Geral', 'Verifique se não está em conta teste
Necessário mudar para biling_v2', '');
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente informa que não consegue reimplantar o container', 'Geral', 'Qual mudança, está tentando fazer?
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente quer criar uma PrivateKey para colocar no N8N', 'Geral', 'Para configurar a Private Key no n8n, você precisa.
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente quer alterar algo como e-mail, senha', 'Geral', 'Alteramos no JCA
Cliente deve mandar e-mail para suporte@saveincloud.com para realizar tal alteração ou exclusão de dados', '');
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente informa sobre erro "no free indoes"', 'Geral', 'Tente aumentar um pouco o espaço em disco utilizado e realizar o reinício novamente.
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente quer fazer conexão com postgres', 'Geral', 'Cliente pode usar o webSSH na própria plataforma.
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Problema em fazer curl performs SSL certificate verification by default, using a “bundle” of Certificate Authority (CA) public keys (CA certs).', 'Geral', 'O servidor não confia no CA do certificado SSL
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente tenta realizar acesso em um ambiente de cópia', 'Geral', 'Utilizando no ambiente principal nc -zv ip porta (comando para estabelecer conexão) funciona, mas na cópia não
Cliente deve liberar a porta no firewall', '');
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente informa que o e-mail é enviado, mas não é recebido', 'Geral', 'Verificar como está configurado as portas do servidor de entrada e saída
...
INSERT INTO erros (titulo, categoria, descricao, solucao) VALUES ('Cliente informa que não é possível excluir/alterar o add-on de reinicio do host / não está funcionando', 'Geral', 'Perguntar se já tentou alteração/remoção do add-on com a conta proprietária
